...
import { getRoutineFormTemplate, addRoutine } from '../services/apiService';
import React, { useState, useEffect } from 'react';
import Select from 'react-select';

const RoutineFormMenu = ({ onClose, allDevices, onAddRoutine }) => {
    ...
    const formTypeOptions = [
        ...
        { value: 'QuickAction', label: 'Quick Action (coming soon)', isDisabled: true },
        { value: 'Preference', label: 'Preference (coming soon)', isDisabled: true }
    ];
